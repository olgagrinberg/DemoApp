...
public class com_gwtplatform_mvp_client_DesktopGinjector_DesktopGinjectorGinjector_fragment {
   ...
   *   com.mytestproject.client.ClientModule.configure(ClientModule.java:21)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.mytestproject.client.ClientModule.configure(ClientModule.java:22)
   */
  ...
  /**
   * Binding for java.lang.String declared at:
   *   com.mytestproject.client.ClientModule.configure(ClientModule.java:23)
   */
